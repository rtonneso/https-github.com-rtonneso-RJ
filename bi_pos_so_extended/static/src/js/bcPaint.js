	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							canvasContainer : $('<div id="bcPaint-canvas-container" style="min-height: 250px;max-width: 450px;"></div>'),
							canvasPane 		: $('<canvas id="bcPaintCanvas" style="background: #ffff;"></canvas>'),
							bottom 			: $('<div id="bcPaint-bottom"></div>'),
							buttonReset 	: $('<button id="bcPaint-reset" style="margin-left: 392px;margin-top: 10px;">Reset</button>'),
